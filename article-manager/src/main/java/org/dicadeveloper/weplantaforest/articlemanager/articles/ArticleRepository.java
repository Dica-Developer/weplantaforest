...
public interface ArticleRepository extends CrudRepository<Article, Long> {
    ...
    public final static String FIND_ARTICLES_BY_TYPE_PAGING_QUERY = "SELECT article FROM Article article WHERE article.articleType = :articleType AND article.lang = :language ORDER BY article.createdOn DESC";
