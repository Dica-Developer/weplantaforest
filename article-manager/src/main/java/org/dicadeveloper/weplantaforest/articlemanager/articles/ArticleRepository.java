...
public interface ArticleRepository extends CrudRepository<Article, Long> {
    ...
    public final static String FIND_ARTICLES_BY_TYPE_QUERY = "SELECT article FROM Article article WHERE article.articleType = :articleType AND article.lang = :language AND article.visible = true ORDER BY article.createdOn DESC";
