...
public class TreeTypeController {
  ...
  @Transactional
  public ResponseEntity<?> uploadUserImage(@RequestParam Long treeTypeId, @RequestParam String imageType,
    ...
    String trimmedName = StringHelper.getTextForLanguage(treeType.getName(), "de");
    int spaceIndex = trimmedName.indexOf(" ") != -1 ? trimmedName.indexOf(" ") : trimmedName.length();
    trimmedName = trimmedName.substring(0, spaceIndex);
