...
public interface UserRepository extends CrudRepository<User, Long> {
    ...
    public final static String GET_USER_DETAILS_QUERY = "SELECT new org.dicadeveloper.weplantaforest.user.UserReportData(user.name, user.imageName, user.regDate, user.lastVisit, user.organizationType)" + " FROM User user WHERE user.name = :name";
