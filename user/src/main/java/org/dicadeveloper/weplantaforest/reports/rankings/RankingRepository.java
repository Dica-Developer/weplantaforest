...
public interface RankingRepository extends PagingAndSortingRepository<User, Long> {
    ...
    Page<TreeRankedUserData> getBestUserFromOrganizationTypeForLastYear(@Param("time") long timeOfMeasurement, @Param("organizationType") OrganizationType organizationType, Pageable page);
