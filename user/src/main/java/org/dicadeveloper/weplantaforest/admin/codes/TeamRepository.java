...
public interface TeamRepository extends CrudRepository<Team, Long> {
    ...
    public final static String GET_TEAM_DETAILS_QUERY = "SELECT new org.dicadeveloper.weplantaforest.admin.codes.TeamReportData(team.id, team.name, team.timeStamp, team.admin.name, (SELECT COUNT(*) FROM User user WHERE user.team.name = :name))"
