...
public class Uris {
    ...
    public final static String RANKING_BEST_ORGANIZATION_TYPE = "/ranking/bestOrgType/";

    public final static String RANKING_LAST_PLANTED_TREES = "/ranking/lastPlantedTrees";
    ...
    public final static String RECEIPT_CREATE_AND_SEND = "/receipt/createAndSend";
