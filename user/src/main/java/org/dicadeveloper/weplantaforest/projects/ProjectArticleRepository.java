...
public interface ProjectArticleRepository extends CrudRepository<ProjectArticle, Long> {
    ...
    public Long findArticleIdByProjectAndTreeType(@Param("projectName") String projectName, @Param("treeTypeName") String treeTypeName);
    ...
    public ProjectArticle findArticleByProjectAndTreeType(@Param("projectName") String projectName, @Param("treeTypeName") String treeTypeName);
