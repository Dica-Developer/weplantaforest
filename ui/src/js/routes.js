    ...
    return (
      <div>
        ...
        <Router history={browserHistory}>
          ...
          <Route path="/plantGift/:amount" component={ProposalPlantPage} updatePlantBag={this.updatePlantBag.bind(this)} reRender={this.reRender.bind(this)} header={counterpart.translate('CREATE_GIFT')}  isGift={true} isAbo={false}/>
          ...
          <Route path="/user/:userName" component={ProfilePage} reRender={this.reRender.bind(this)} logout={this.logout.bind(this)} updateLanguage={this.updateLanguage.bind(this)} loadUserDetails={this.loadUserDetails.bind(this)}/>
