...
export default class Privacy extends Component {
  ...
  componentDidMount() {
    var that = this;
    axios
      .get('http://localhost:8082/articles?articleType=PRIVACY&language=' + localStorage.getItem('language'))
      .then(function(response) {
        var result = response.data;
        for (var privacy in result) {
          axios
            .get('http://localhost:8082/reports/article/' + result[privacy].id)
            .then(function(response) {
