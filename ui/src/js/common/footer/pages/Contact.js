...
export default class Contact extends Component {
  ...
  componentDidMount() {
    var that = this;
    axios
      .get('http://localhost:8082/articles?articleType=CONTACT&language=' + localStorage.getItem('language'))
  ...
  submit() {
    if (this.validateForm()) {
      var that = this;
      axios
        .post('http://localhost:8081/contact', this.state.form)
        .then(function(response) {
