...
export default class PaymentPage extends Component {
  ...
  render() {
    ...
    if (this.state.paymentOption == '') {
      content = <Overview price={this.state.plantBag.price} setPaymentOption={this.setPaymentOption.bind(this)} cartId={this.state.cartId} resetPlantBag={this.resetPlantBag.bind(this)}/>
