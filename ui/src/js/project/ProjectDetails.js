...
export default class ProjectDetails extends Component {
  ...
  render() {
    ...
    return (
      <div ref="details" className={(this.state.fade ? 'fadeOut' : 'fadeIn') + ' projectDetails'}>
        <h1>
            ...
            <tr>
              <td>
                <div className="floatRight">
                  <span className="greenValue">{formattedPercent}%</span>
                  <br />
              ...
              <td>
                <span className="greenValue">{Accounting.formatNumber(this.props.project.projectReportData.amountOfPlantedTrees, 0, '.', ',')}</span>
                <br />
                <span className="tableText">
                  <i>
                    {counterpart.translate('OF')}&nbsp;{Accounting.formatNumber(this.props.project.projectReportData.amountOfMaximumTreesToPlant, 0, '.', ',')}&nbsp;{counterpart.translate('TREES')}
                  </i>
                </span>
              </td>
            </tr>
