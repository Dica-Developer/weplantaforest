  ...
  render() {
    ...
    return (
      <div className="plantItem">
        ...
        <div>
          <p>
            <span className="uppercase bold">{getTextForSelectedLanguage(this.props.plantItem.treeType)}</span><br/>{Accounting.formatNumber(this.props.plantItem.treePrice / 100, 2, '.', ',')}&nbsp;€
          </p>
        </div>
        <div>
