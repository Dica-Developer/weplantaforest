      ...
      <div className="plantItem">
        ...
        <div>
          <p>
            ...
            <br />
            {Accounting.formatNumber(this.props.plantItem.treePrice / 100, 2, '.', ',')}&nbsp;€
          </p>
        </div>
        <div>{this.props.plantItem.amount}</div>
        <div>{this.props.plantItem.projectName}</div>
        <div></div>
        <div>{Accounting.formatNumber((this.props.plantItem.treePrice * this.props.plantItem.amount) / 100, 2, '.', ',')}&nbsp;€</div>
      </div>
    );
  }
}
