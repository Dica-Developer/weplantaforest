...
export default class Banner extends Component {
  ...
  generateHtmlCode() {
    var that = this;
    axios
      .get('http://localhost:8081/banner/code?type=' + this.state.type + '&width=' + this.state.width + '&height=' + this.state.height)
  ...
  render() {
    ...
    if (this.state.format == 'high') {
      ...
      bannerImages = (
        <div className="bannerImages-high">
          <div className="image">
            <img src={banner1} />
            <br />
      ...
      bannerImages = (
        <div className="banner-images-cross">
          <div className="image">
    ...
    return (
      <div className="col-md-12">
        <h1>
          {counterpart.translate('TOOLS')}&nbsp;/&nbsp;{counterpart.translate('BANNER')}
        </h1>
          ...
          <div className="banner">
            ...
            <div className="code-and-options">
              <div className="options">
                ...
                <LeftRightSwitch
                  leftText={counterpart.translate('WHITE')}
                  rightText={counterpart.translate('GREEN')}
                  leftValue="white"
                  rightValue="green"
                  chosenValue={this.state.type}
                  onClick={this.updateType.bind(this)}
                />
                <br />
                <LeftRightSwitch
                  leftText={counterpart.translate('VERTICAL')}
                  rightText={counterpart.translate('HORIZONTAL')}
                  leftValue="high"
                  rightValue="cross"
                  chosenValue={this.state.format}
                  onClick={this.updateFormat.bind(this)}
                />
              </div>
              <div className="code">
